	...
	<div class="col-md-12">
		<div class="widget">
			<div class="widget-header">
				<h2><strong>Mevcut Yorumlar</strong></h2>
				...
				<div class="table-responsive">
					<form class='form-horizontal' role='form'>
						<table class="mail table table-hover datatable" cellspacing="0" width="100%">
							...
							<tbody>
								<?php
								$slideQuery = $db->query("SELECT * FROM fotograflar WHERE fotograf_bolum=6");
											...
											<td>
												<div class="btn-group dropdown">
													...
													<ul class="dropdown-menu danger" role="menu">
														<li><a href="index.php?sayfa=musteri_duzenle&id=<?php echo $slideRow["fotograf_id"];?>">Görüntüle / Düzenle</a></li>
														<li>
...
function durumDegis(slideId){
	$.post('ajax.php?p=foto_durum_degis', {id: slideId}, function (data) {
		if(data=="yasaklama-basarili"){
			sweetAlert({
				title	: "Başarılı",
				text 	: "Yorum başarılı bir şekilde yayından kaldırıldı.",
				type	: "success"
			},
			function(){
				window.location.reload(true);
			...
			sweetAlert({
				title	: "Başarılı",
				text 	: "Yorum başarılı bir şekilde yayınlandı.",
				type	: "success"
			},
			function(){
				window.location.reload(true);
